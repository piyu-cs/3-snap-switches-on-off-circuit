...
**👥 Group Members:** Me and Ruwanthi kalpana  
...
This circuit triggers an audible alert upon detecting two consecutive hand claps within three seconds. Designed for efficiency and simplicity, it utilizes only 555 Timer ICs and optimized electronic components—no logic gate ICs needed!
...
The microphone captures hand clap sounds, which are then filtered and processed by two 555 Timer ICs configured as monostable multivibrators. If two claps are detected within three seconds, the buzzer activates, making it an efficient and user-friendly key tag detection system.
